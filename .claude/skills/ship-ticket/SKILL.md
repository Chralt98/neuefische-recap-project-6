---
name: ship-ticket
description: "Commit, push, and open a PR for a reviewed and documented ticket, then move its board card to Review. Use for the stage:ship step of the AI factory pipeline."
...
3. Remove the `stage:ship` label.
4. Move the board card to "Review". If the board has no "Review" status column, create one (between "In Progress" and "Done") and use it from then on.
